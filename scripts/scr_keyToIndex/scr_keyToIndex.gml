function scr_keyToIndex(argument0) {
	var key = argument0;
	if (key == vk_right) return 72;
	if (key == vk_left) return 69;
	if (key == vk_down) return 71;
	if (key == vk_up) return 70;
	if (key == vk_tab) return 19;
	if (key == vk_space) return 68;
	if (key == vk_backspace) return 15;
	if (key == vk_escape) return 1;
	if (key == vk_enter) return 32;
	if (key == vk_shift) return 52;
#region numpad
	if (key == vk_numpad0) return 73;
	if (key == vk_numpad1) return 64;
	if (key == vk_numpad2) return 65;
	if (key == vk_numpad3) return 66;
...
#region punctuation
	...
	if (key == 220) return 53; // backslash
