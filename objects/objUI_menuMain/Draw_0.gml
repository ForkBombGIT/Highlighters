	...
	case 1:
		...
		switch(menuSection) {
			case 0:
				...
				break;
			case 2:
				draw_sprite(spr_menu_p1_tutorial,(cursorPosition == 0) ? floor(optionAnimationIndex) : 0,120,198);
				break;
			case 4: 
		...
		draw_sprite(spr_menu_main_a,(menuSection * 2) + menuSectionIndex, 96, 360);
		break;
		#endregion
	case 2:
