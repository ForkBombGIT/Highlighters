...
switch (state) {
	...
	case 0:
		...
		draw_sprite((cursorPosition == 2) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 2) ? 78 : scr_keyToIndex(ds_map_find_value(inputMap,"UP")),432,144);
		//down
		if (cursorPosition == 3) draw_sprite(spr_options_inputs,3,24,168);
		draw_sprite((cursorPosition == 3) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 3) ? 78 :scr_keyToIndex(ds_map_find_value(inputMap,"DOWN")),432,168);
		//left
		if (cursorPosition == 4) draw_sprite(spr_options_inputs,4,24,192);
		draw_sprite((cursorPosition == 4) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 4) ? 78 :scr_keyToIndex(ds_map_find_value(inputMap,"LEFT")),432,192);
		//right
		if (cursorPosition == 5) draw_sprite(spr_options_inputs,5,24,216);
		draw_sprite((cursorPosition == 5) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 5) ? 78 :scr_keyToIndex(ds_map_find_value(inputMap,"RIGHT")),432,216);
		//swap/ok
		if (cursorPosition == 6) draw_sprite(spr_options_inputs,6,24,240);
		draw_sprite((cursorPosition == 6) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 6) ? 78 :scr_keyToIndex(ds_map_find_value(inputMap,"A")),432,240);
		//rise/back
		if (cursorPosition == 7) draw_sprite(spr_options_inputs,7,24,264);
		draw_sprite((cursorPosition == 7) ? spr_keys : spr_keys_faded,inputChangeKey && (cursorPosition == 7) ? 78 :scr_keyToIndex(ds_map_find_value(inputMap,"B")),432,264);
		//pause/quit
